...
__constant char internal_to_cks_data_rt[2] = { -1, -1 };
__constant char internal_to_cks_control_rt[2] = { 0, 1 };

// logical port -> index in channels_to_ck_r -> ck_r channel
__constant char internal_from_ckr_data_rt[2] = { 0, 1 };
__constant char internal_from_ckr_control_rt[2] = { -1, -1 };

channel SMI_Network_message channels_cks_data[0] __attribute__((depth(16)));
channel SMI_Network_message channels_cks_control[2] __attribute__((depth(16)));
channel SMI_Network_message channels_ckr_data[2] __attribute__((depth(BUFFER_SIZE)));
channel SMI_Network_message channels_ckr_control[0] __attribute__((depth(BUFFER_SIZE)));

 ...
 * for the latency example. In this case
 * we have only one application that is connected to CK_S_0 and CK_R_0
 */
...
//this is a bad trick, to avoid having 2 generated file...please don't try this at home

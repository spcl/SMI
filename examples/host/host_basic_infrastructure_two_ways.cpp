...
int main(int argc, char *argv[])
{
    ...
    std::vector<std::string> kernel_names={"app_sender","app_receiver_1","app_receiver_2","CK_sender_0","CK_sender_1","CK_receiver_0","CK_receiver_1"};
    ...
    kernels[1].setArg(0,sizeof(cl_mem),&check_1);
    kernels[1].setArg(1,sizeof(int),&n);
    kernels[2].setArg(0,sizeof(cl_mem),&check_2);

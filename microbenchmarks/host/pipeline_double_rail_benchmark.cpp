...
int main(int argc, char *argv[])
{
    ...
    {
        if(emulator)
            program_path = ("emulator_" + std::to_string(rank) +"/pipeline_double_rail.aocx");
        else
    ...
    SMI_Comm comm=SmiInit_pipeline_double_rail(rank, rank_count, ROUTING_DIR, context, program, buffers);

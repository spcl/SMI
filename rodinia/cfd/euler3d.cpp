...
void compute_flux(int nelr, cl_mem elements_surrounding_elements,
                  cl_mem normals, VariablesD& variables, cl_mem ff_variable,
                  VariablesD& fluxes,
                  cl_mem ff_flux_contribution_density_energy,
                  cl_mem ff_flux_contribution_momentum_x,
                  cl_mem ff_flux_contribution_momentum_y,
                  cl_mem ff_flux_contribution_momentum_z) {
  int work_items = nelr;
    ...
    for (int j = 0; j < RK; j++) {
      if (is_ndrange_kernel(version_number)) {
        compute_flux(nelr, elements_surrounding_elements, normals, variables,
                     ff_variable, fluxes, ff_flux_contribution_density_energy,
        ...
        compute_flux(
            nelr, elements_surrounding_elements, normals, variables_soa,
            ff_variable, fluxes_soa, ff_flux_contribution_density_energy,
            ff_flux_contribution_momentum_x, ff_flux_contribution_momentum_y,
            ff_flux_contribution_momentum_z);
        time_step(j, nelr, old_variables_soa, variables_soa, step_factors,
                  fluxes_soa);
      }
    }
  }
